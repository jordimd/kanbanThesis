...
<div id="editUserName" class="editUser" style="display:block">
    ...
    <p>Password<input id="passwordUser" type="password" name="password" maxlength="20" required></p>
...
<div id="editUserPass" class="editUser" style="height: 110px">
    ...
    Old password<input id="passUser" type="password" name="oldPassword" maxlength="20" required>
    <p>New Password<input type="password" name="newPassword" maxlength="20" title="Enter a password between 4 to 20 characters" pattern="\S{4,20}" required> </p>
    <p>Repeat<input id="newPassUser" type="password" name="newPassword2" maxlength="20" required></p>
    <button style="float:right">Modify</button>
    </form>
    <button style="float:left" onClick="cancelEdit()">Cancel</button>
</div>

<div id="editDeleteUser" class="editUser" style="height: 60px; width:327px">
    
    <form action="editUser.php" method="post" onSubmit="return deleteUser()">
    Please write your password to delete the user.
    <p><input id="passUserDelete" type="password" name="deleteUserPass" placeholder="Password" maxlength="20" required> </p>
    <button style="width:25%; float:right">Delete</button>
    </form>
    <button style="width:22%; position:absolute; right:108px" onClick="cancelEdit()">Cancel</button>
